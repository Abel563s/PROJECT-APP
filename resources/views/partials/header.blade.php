    ...
    <div class="flex items-center gap-6">
        ...
        <div class="relative group" x-data="{ open: false }">
            <button @click="open = !open"
                class="w-10 h-10 rounded-[10px] bg-[#00ADC5]/10 border border-[#00ADC5]/20 text-[#00ADC5] flex items-center justify-center font-black text-xs hover:bg-[#00ADC5]/20 hover:border-[#00ADC5]/30 hover:shadow-lg hover:shadow-cyan-100/30 transition-all duration-250 overflow-hidden">
