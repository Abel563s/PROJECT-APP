<form action="{{ route('admin.weekly-updates.store') }}" method="POST" id="weeklyModalForm" class="space-y-4">
    @csrf
        ...
        <div class="grid grid-cols-2 gap-3">
            <div class="space-y-1">
                ...
                <textarea name="status" rows="2"
                    class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-[10px] font-bold text-slate-700 focus:ring-2 focus:ring-cyan-100/50 focus:bg-white focus:border-[#00ADC5]/20 transition-all"></textarea>
            </div>
            <div class="space-y-1">
            ...
            <div class="space-y-1">
                ...
                <textarea name="constraints" rows="2"
                    class="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-lg text-[10px] font-bold text-slate-700 focus:ring-2 focus:ring-rose-100/50 focus:bg-white focus:border-[#00ADC5]/20 transition-all"></textarea>
            </div>
        </div>
        <div class="space-y-1">
    ...
    <div class="flex justify-end pt-2">
        <button type="submit" form="weeklyModalForm"
