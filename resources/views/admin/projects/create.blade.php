        ...
        <form action="{{ route('admin.projects.store') }}" method="POST" id="project-form" class="space-y-12">
            ...
            <div
                ...
                <div class="flex items-center gap-4 relative z-10">
                    ...
                    <div>
                        <h3 class="text-xl font-black text-slate-900 tracking-tight">3. Budget & Cost Management</h3>
            ...
            <div
                ...
                <div class="flex items-center gap-4 relative z-10">
                    ...
                    <div>
                        <h3 class="text-xl font-black text-slate-900 tracking-tight">4. Schedule & Timeline (Time Management)</h3>
